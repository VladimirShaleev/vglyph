 ...
 *
 * File: vglyph-rgba-uint32-data-render.c
...
void
_vglyph_rgba_uint32_data_render_ctor(vglyph_rgba_uint32_data_render_t* render)
{
    _vglyph_render_ctor(&render->base);

    if (_vglyph_rgba_uint32_data_render_is_valid(render))
    {
    }
}

void
_vglyph_rgba_uint32_data_render_dtor(vglyph_rgba_uint32_data_render_t* render)
{
    _vglyph_render_dtor(&render->base);
}

vglyph_bool_t
_vglyph_rgba_uint32_data_render_is_cast(vglyph_type_t* type)
{
    return _vglyph_rgba_uint32_data_render_get_type() == type
        || _vglyph_render_is_cast(type);
}

vglyph_type_t*
_vglyph_rgba_uint32_data_render_get_type(void)
{
    static vglyph_type_t type = _vglyph_type_create(_vglyph_rgba_uint32_data_render_is_cast);
    return &type;
}

static void
_vglyph_rgba_uint32_data_render_destroy(vglyph_object_t* object)
{
    vglyph_rgba_uint32_data_render_t* render = (vglyph_rgba_uint32_data_render_t*)object;
    _vglyph_rgba_uint32_data_render_dtor(render);
...
static void
_vglyph_rgba_uint32_data_render_set_pixel(vglyph_render_t* render,
                                          vglyph_surface_t* surface,
                                          vglyph_sint32_t x,
                                          vglyph_sint32_t y,
                                          const vglyph_color_t* color)
...
static void
_vglyph_rgba_uint32_data_render_alpha_blend(vglyph_render_t* render,
                                            vglyph_surface_t* surface,
                                            vglyph_sint32_t x,
                                            vglyph_sint32_t y,
                                            const vglyph_color_t* color)
{
    ...
    else
    {
        ...
        _vglyph_rgba_uint32_data_render_get_pixel(render, surface, x, y, &dest_color);
        ...
        _vglyph_rgba_uint32_data_render_set_pixel(render, surface, x, y, &result);
    }
}

static const vglyph_object_backend_t vglyph_rgba_uint32_data_render_object_backend = {
    _vglyph_rgba_uint32_data_render_get_type,
    _vglyph_rgba_uint32_data_render_is_cast,
    _vglyph_rgba_uint32_data_render_destroy
};

static const vglyph_render_backend_t vglyph_rgba_uint32_data_render_backend = {
    _vglyph_rgba_uint32_data_render_fill,
    _vglyph_rgba_uint32_data_render_get_pixel,
    _vglyph_rgba_uint32_data_render_set_pixel,
    _vglyph_rgba_uint32_data_render_alpha_blend
};
