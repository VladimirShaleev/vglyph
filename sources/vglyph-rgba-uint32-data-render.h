 ...
 *
 * File: vglyph-rgba-uint32-data-render.h
 * Copyright (C) 2017 Shaleev Vladimir
 */

#ifndef VGLYPH_RGBA_UINT32_RENDER_H
#define VGLYPH_RGBA_UINT32_RENDER_H

#include "vglyph-render.h"

typedef struct _vglyph_rgba_uint32_data_render
{
    vglyph_render_t base;
    vglyph_bool_t   swap_bytes;
} vglyph_rgba_uint32_data_render_t;
...
static inline void
_vglyph_rgba_uint32_data_render_set_state(vglyph_rgba_uint32_data_render_t* render,
...
_vglyph_rgba_uint32_data_render_is_valid(vglyph_rgba_uint32_data_render_t* render)
{
    assert(render);
...
static inline void
_vglyph_rgba_uint32_data_render_uint32_to_color(vglyph_render_t* render,
                                                vglyph_rgba_uint_format_t* format,
                                                vglyph_uint32_t data,
                                                vglyph_color_t* color)
{
    ...
    if (((vglyph_rgba_uint32_data_render_t*)render)->swap_bytes)
        data = _vglyph_swap_uint32(data);
...
_vglyph_rgba_uint32_data_render_color_to_uint32(vglyph_render_t* render,
                                                vglyph_rgba_uint_format_t* format,
                                                const vglyph_color_t* color)
{
    ...
    if (((vglyph_rgba_uint32_data_render_t*)render)->swap_bytes)
        result = _vglyph_swap_uint32(result);
