# Glyph.VerticalBearingY Property 
...
**C#**<br />
``` C#
public float VerticalBearingY { get; set; }
```

**VB**<br />
``` VB
Public Property VerticalBearingY As Single
	Get
	Set
```
...
**F#**<br />
``` F#
member VerticalBearingY : float32 with get, set
